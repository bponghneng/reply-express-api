defmodule ReplyExpress.Accounts.Commands.AddUserToTeam do
  ...
  validates :role, presence: [message: "can't be empty"],
                   inclusion: [in: ["admin", "member"], message: "must be either 'admin' or 'member'"]

  @doc """
  Sets the team UUID for the command.
  """
  def set_team_id(%__MODULE__{} = command, team_uuid) do
  ...
  """
  def set_user_id(%__MODULE__{} = command, user_uuid) do
